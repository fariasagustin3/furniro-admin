              ...
              <tr className='border-b-[1px]'>
                <td className='py-2'>
                  <div className='flex items-center justify-center'>
                    <img className='w-12 h-12 rounded-md' src="/product.jpg" alt="" />
                  </div>
                </td>
                <td className='text-center text-sm font-medium'>Classic Sofa</td>
                <td className='text-center text-sm font-medium'>$1200</td>
                <td >
                ...
                <td className='text-center text-sm font-medium'>Yes</td>
                <td className='text-center text-sm font-medium'>15</td>
                <td className='text-center text-sm font-medium'>Living Room</td>
                <td>

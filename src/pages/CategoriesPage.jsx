  ...
  return (
    <Layout>
      <div className="w-full h-screen px-10 pb-10 overflow-auto">
        <h1 className="font-medium text-md text-[#202224]">Categories</h1>
          ...
          <div>
            <div className="py-4 px-5 bg-white rounded-md flex flex-row items-center justify-between gap-5 shadow-2xl w-full">
              ...
              <select className="font-medium text-sm focus:outline-none">
                ...
                <option>Products: Ascending</option>
                <option>Products: Descending</option>
              </select>
                ...
                <tr className='border-b-[1px]'>
                  <td className='py-2'>
                    <div className='flex items-center justify-center'>
                      <img className='w-12 h-12 rounded-md object-cover' src="/living-room.jpg" alt="" />
                    </div>
                  </td>
                  <td className='text-center text-sm font-medium'>Living Room</td>
                  <td className='text-center text-sm font-medium'>18</td>
                  <td>
                    <div className="flex items-center justify-center">
                      <span className='text-center text-sm font-medium'>Active</span>
                    </div>
                  </td>
                  <td>
